...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.input_img.setStyleSheet(u"background-color: rgb(211, 211, 211);\n"
"")
        ...
        self.output_img.setStyleSheet(u"background-color: rgb(211, 211, 211);\n"
"")
        self.select_image = QPushButton(self.centralwidget)
        self.select_image.setObjectName(u"select_image")
        self.select_image.setGeometry(QRect(220, 520, 150, 50))
        font = QFont()
...
"background-color: rgb(85, 0, 127);")
        ...
        self.save_image.setGeometry(QRect(675, 540, 150, 61))
...
"color: #FFFFFF;")
        self.capture_image = QPushButton(self.centralwidget)
        self.capture_image.setObjectName(u"capture_image")
        self.capture_image.setGeometry(QRect(220, 580, 150, 50))
        self.capture_image.setFont(font)
        self.capture_image.setStyleSheet(u"border-width: 2px;\n"
"border-radius: 16px;\n"
...
"color: #FFFFFF;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.select_image.setText(QCoreApplication.translate("MainWindow", u"Show Image cam", None))
        self.save_image.setText(QCoreApplication.translate("MainWindow", u"Save Image", None))
        self.super_resolve.setText(QCoreApplication.translate("MainWindow", u"Uprgade Image", None))
        self.capture_image.setText(QCoreApplication.translate("MainWindow", u"Camera Image", None))
    # retranslateUi
